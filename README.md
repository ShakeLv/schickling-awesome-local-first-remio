...
- [Remio](https://remio.ai/): Local-first AI memory and knowledge base desktop app for personal context retrieval across files, webpages, recordings, emails, messages, and images.
